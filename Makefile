...
results/age_survived.csv /results/age_survived.svg /results/fare_survived.csv /results/fare_survived.svg: results/clean_titanic.csv src/linear_model_and_plot.R
	Rscript src/linear_model_and_plot.R results/clean_titanic.csv

# create final report
doc/report.md: src/Analysis_report.Rmd results/age_survived.csv /results/age_survived.svg /results/fare_survived.csv /results/fare_survived.svg
	Rscript -e "ezknitr::ezknit('src/Analysis_report.Rmd', out_dir = 'doc')"

# delete intermediate files
clean:
	rm -f results/age_survived.csv
	rm -f results/age_survived.svg
	rm -f results/fare_survived.csv
	rm -f results/fare_survived.svg
